...
/** 
 * Coinbase smart wallet, from https://www.smartwallet.dev/guides/components/create-wallet-button
*/
...
export function BlackCreateWalletButton({ height = 60, width = 190 }) {
